...
const tableCreator = (() => {
	const heroesTablesTemplate = document.getElementById("heroesTablesTemplate");
	const containerHeroes = document.getElementById(containerHeroes);
	const clone = heroesTablesTemplate.cloneNode(true).content;
	const fragment = document.createDocumentFragment();

	const hero = heroes.map((hero) => {
		clone.querySelector(".tableOneSuperHero").innerText = hero.name;
		fragment.appendChild(clone);
	});
	containerHeroes.appendChild(fragment);
})();
